...
namespace rws2016_pdias
{
    ...
    class Player
    {
        public:
             ...
             *
             * @return the transform from map to the /pdias local reference frame
             */
...
} //end of namespace rws2016_pdias
...
int main(int argc, char** argv)
{
    ...
    ros::init(argc, argv, "pdias");
    ros::NodeHandle node;

    //Creating an instance of class MyPlayer
    rws2016_pdias::MyPlayer my_player("pdias", "red");
